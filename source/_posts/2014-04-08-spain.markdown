...
with her friends to maybe stay with there. Win!
...
Some parts of the place have a bit of a dragon theme to it, with lots of scales
...
whirlpool vortex, with curved walls, curved doors... curved everything.
...
The internal stairwell is tiled with blue tiles, but using darker tiles at the
...
style. I don't know why every chimneys needs it's own separate bit at the very
top, but it makes it look interesting at least.
...
The roof tiles used on the very top of the front really look like scales, with
the apex looking kind of like a colourful spine.

Yet another building that would have been so cool to actually live in.
...
I went back to La Sagrada Familia and the second time the lines were much more
reasonable and I got in in about 20 minutes. This was one of my favourite
buildings the last time I came to Spain and it still is today.
...
The building has been under construction for well over 100 years now, with some
information in the museum underneath estimating it will be completed in 2030 so
I may even live to see it finished. My favourite side of the building last time
was "The Passion" façade, which this time unfortunately was partially covered in
scaffolding.
...
I saw this model and found out that even though the building is already huge,
it's still missing the 5 or 6 tallest towers. The central "Jesus" tower alone is
...
I got to go up one of the Nativity towers, which thankfully they have an
...
It was a lot of steps down from the tower, in a rather dizzying spiral, but it's
better walking down steps than up them.
...
The time of day, and the intensity of the sun with clear skies, mean that the
stained glass was casting lots of really pretty light inside the building. There
are still large area where the windows are plain glass, so I can only imagine
the rainbow this place will be when all the windows are done.

I just love all the clean complexity of all the shapes involved, with so much of
it coming from fairly basic math and geometry concepts. The columns for example
are [double
twisted](http://www.sagradafamilia.cat/sf-eng/docs_instit/geometria1.php),
meaning (I think) that they have twice as many "sides" at their tops than they
do at the bottom, but there's no sudden point where this shape change takes
